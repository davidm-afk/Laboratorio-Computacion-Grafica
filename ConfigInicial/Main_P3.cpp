...
int main() {
 ...
 //     
	...
	//
		...
		//sexto cubo
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(0.60f, 1.5f, 1.2f));
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		...
		//octavo cubo
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(2.0f, 1.5f, 1.2f));
		...
		//decimo cubo
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-1.35f, 2.5f, 2.0f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		...
		//trecavo cubo
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(0.6f, 3.25f, 2.5f));
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		//quinceavo cubo
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(0.0f, 3.91f, 2.5f));
		model = glm::rotate(model, glm::radians(180.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(0.65f, 0.65f, 0.65f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
